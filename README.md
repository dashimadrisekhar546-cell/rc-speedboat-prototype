...
**Working Speedboat Model - Hobby Project | CAD, Fabrication, Propulsion**

- Designed, fabricated, assembled, and tested a remote-controlled speedboat prototype.
- Integrated propulsion, steering, battery, ESC, motor, propeller, and control systems.
- Optimized stability, maneuverability, and performance through iterative water testing.
